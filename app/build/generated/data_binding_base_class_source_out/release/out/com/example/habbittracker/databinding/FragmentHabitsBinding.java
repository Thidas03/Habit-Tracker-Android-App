...
public final class FragmentHabitsBinding implements ViewBinding {
  ...
  private FragmentHabitsBinding(@NonNull ConstraintLayout rootView,
      @NonNull MaterialCardView cardProgress, @NonNull FloatingActionButton fabAddHabit,
      @NonNull LinearLayout layoutEmpty, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView recyclerViewHabits, @NonNull TextView textViewProgress) {
  ...
  public static FragmentHabitsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHabitsBinding((ConstraintLayout) rootView, cardProgress, fabAddHabit,
          layoutEmpty, progressBar, recyclerViewHabits, textViewProgress);
    }
